...
namespace MvcWithEf.Migrations
{
    ...
    [Migration("20191209123505_Add_column_DateModified")]
    partial class Add_column_DateModified
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MvcWithEf.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MvcWithEf.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("MvcWithEf.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MvcWithEf.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("MvcWithEf.Models.Course", b =>
                {
                    b.HasOne("MvcWithEf.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("MvcWithEf.Models.CourseInstructor", b =>
                {
                    ...
                    b.HasOne("MvcWithEf.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("MvcWithEf.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("MvcWithEf.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("MvcWithEf.Models.OfficeAssignment", b =>
                {
                    b.HasOne("MvcWithEf.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("MvcWithEf.Models.OfficeAssignment", "InstructorId")
